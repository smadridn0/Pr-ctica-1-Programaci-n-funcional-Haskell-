...
Otro problema que encontramos tenía que ver con el tipo de dato que toma nuestra función de remover datos, pues originalmente estaba tomando unicamente Ints, con lo cual, si bien funcionaba, no estabamos seguros de si si era indicado, o si debería funcionar también con con numeros decimales. Debido a esto decidimos que tomara cualquier tipo de dato (a), restringido para que fuera ordenable.
